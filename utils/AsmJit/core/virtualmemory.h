...
struct VirtualMemory
{
  ...
  //HCF No Handle
  ASMJIT_API static void* allocProcessMemory(size_t length, size_t* allocated, bool canExecute);
  ...
  //! @note This function is Windows specific.
  //HCF No Handle
  ASMJIT_API static void freeProcessMemory(void* addr, size_t length);
