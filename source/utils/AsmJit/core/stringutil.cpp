...
char* StringUtil::utoa(char* dst, unsigned long i, size_t base)
{
...
//HCF OJO intptr_t = signed long
char* StringUtil::itoa(char* dst, unsigned long i, size_t base)
