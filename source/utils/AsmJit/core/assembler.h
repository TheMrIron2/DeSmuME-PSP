...
struct Assembler
{
  ...
  //! @brief Get unsigned long at position @a pos.
  ...
  inline void setUInt64At(size_t pos, unsigned long x)
  ...
  //! @brief Emit unsigned long (4 or 8 bytes) to internal buffer.
  inline void _emitUIntPtrT(unsigned long x)
  ...
  { return relocCode(dst, (unsigned long)dst); }
